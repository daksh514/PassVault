...
function Hero() {
  return (
    <>
      <div className='w-screen  lg:h-[80vh] mx-auto max-w-6xl px-1 flex justify-between max-lg:flex-col max-lg:items-center'>
      ...
      {/* <h1 className='max-lg:hidden text-center text-sm text-[#515151fe] mt-2'>Scroll below to see how this can save you hours👇</h1> */}
        ...
        <div className='lg:w-1/2 flex items-center justify-end lg:h-[70vh] max-lg:justify-center max-lg:mt-10 lg:min-h-[510px]'>
          <Generator />
        </div>
      </div>
    </>
